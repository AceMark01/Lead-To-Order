...
function App() {
  ...
  const fetchUserData = async (username, userType) => {
    try {
      ...
      const dataUrl = "https://docs.google.com/spreadsheets/d/1d4iBP4saSADGyxBR0zDLgq8x-hfzfeS9_74hPtLU_sM/gviz/tq?tqx=out:json&sheet=Data"
  ...
  const login = async (username, password) => {
    try {
      ...
      const loginUrl = "https://docs.google.com/spreadsheets/d/1d4iBP4saSADGyxBR0zDLgq8x-hfzfeS9_74hPtLU_sM/gviz/tq?tqx=out:json&sheet=Login"
