  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      rowData.push(
        ...
        "", // P: Enquiry for State (empty - moved to description)
      ...
      // Add empty columns up to column CF (index 83) for Description
      while (rowData.length < 83) {
        rowData.push("")
      }

      // Add Description at column CF (index 83)
      rowData.push(enquiryFormData.description || "") // CF: Description
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <textarea
                  ...
                  onChange={(e) => setEnquiryFormData({ ...enquiryFormData, description: e.target.value })}
                  rows={3}
                />
              </div>
            </div>
